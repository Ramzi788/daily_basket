...
List catList = [
  [
    ...
    const Color.fromARGB(255, 80, 207, 97),
  ...
  [
    ...
    const Color.fromARGB(255, 193, 63, 186),
...
List list = [
  [
    "Meats",
    FluentIcons.food_chicken_leg_16_filled,
  ...
  [
    "Home Products",
    FluentIcons.spray_can_16_filled,
    "https://cdn.pixabay.com/photo/2016/12/06/18/27/milk-1887234_1280.jpg",
  ...
  [
    ...
    "https://cdn.pixabay.com/photo/2016/12/06/18/27/milk-1887234_1280.jpg",
    const Color.fromARGB(255, 18, 78, 20),
  ],
  [
    "Sauces & Oils",
    FontAwesomeIcons.bottleDroplet,
    "https://cdn.pixabay.com/photo/2016/12/06/18/27/milk-1887234_1280.jpg",
    const Color.fromARGB(255, 119, 18, 10),
  ],
  [
    "Pet Food",
